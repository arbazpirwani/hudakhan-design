...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    ...
    >
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-dynamic-background via-dynamic-background to-dynamic-accent/20" />
      <motion.div
        style={{ scale }}
          ...
          >
            ...
            <motion.div variants={textVariants}>
              ...
              >
                ...
                <br />
                <span className="text-dynamic-text-primary">Experiences That</span>
                <br />
                <span className="text-dynamic-text-primary">Drive Impact</span>
              </Text>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full max-w-lg mx-auto">
                <div className="aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-dynamic-accent/20 to-dynamic-accent-secondary/20 p-2">
                ...
                <div className="absolute -bottom-6 -left-6 w-32 h-32 border-2 border-dynamic-accent/30 rounded-full" />
                <div className="absolute top-1/2 -left-8 w-4 h-4 bg-dynamic-accent-secondary rounded-full animate-bounce" />
                <div className="absolute top-1/4 -right-12 w-6 h-6 bg-dynamic-accent rounded-full opacity-60" />
              </div>
            </motion.div>
