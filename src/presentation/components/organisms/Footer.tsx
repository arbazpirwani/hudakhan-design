...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className={`bg-dynamic-background border-t border-dynamic-border ${className}`}>
      {/* Marquee Text */}
      <div className="relative overflow-hidden py-8 border-b border-dynamic-border">
        <motion.div
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <motion.div variants={itemVariants}>
            ...
            {/* Availability Status */}
            <div className="mt-6 p-4 bg-dynamic-background-tertiary rounded-xl border border-dynamic-border">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row justify-between items-center pt-12 mt-12 border-t border-dynamic-border"
        >
          <Text variant="caption" color="secondary">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-dynamic-accent to-dynamic-accent-secondary text-dynamic-text-primary rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300 z-40"
