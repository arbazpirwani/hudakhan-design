      ...
      <Link href={`/projects/${project.id}`}>
        ...
        <div className="relative w-full h-full">
          ...
          <motion.div
            ...
            initial="hidden"
            whileHover="visible"
            className="absolute inset-0 bg-gradient-to-t from-dynamic-background/80 via-dynamic-background/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          />
          ...
          {project.metrics && !floating && (
            <div className="absolute top-4 left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="bg-black/60 backdrop-blur-sm text-white text-xs font-medium px-2 py-1 rounded-xl border border-gray-600/30">
        ...
        {!floating && (
          <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-dynamic-background to-transparent">
            <Text variant="body" weight="medium" className="text-dynamic-text-primary mb-1">
              {project.title}
            </Text>
            <Text variant="caption" className="text-dynamic-accent">
