      ...
      <div className="relative">
        <select
          ...
          className={`
            ...
            ${!value ? 'text-dynamic-text-muted' : ''}
          `}
          {...props}
        >
          <option value="" disabled className="text-dynamic-text-muted">
            {placeholder}
          </option>
          {options.map((option) => (
            <option 
              key={option.value} 
              value={option.value}
              className="text-dynamic-text-primary bg-dynamic-background-secondary"
            >
              {option.label}
            </option>
          ))}
