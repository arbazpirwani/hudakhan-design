...
const StatCounter: React.FC<StatCounterProps> = ({
  ...
  const { numeric: targetValue, suffix: valueSuffix } = parseValue(value);
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mx-auto mt-3 h-0.5 bg-gradient-to-r from-transparent via-purple-500 to-transparent max-w-20"
      />
    </motion.div>
  );
};
